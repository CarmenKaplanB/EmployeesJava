 ...
 * UserDetails es una clase propia de Spring Security que proporciona información básica del usuario.
 */
public class UsuarioMain implements UserDetails {
    ...
    //@Override los que tengan esta anotación significa que son metodos de UserDetails de SpringSecurity
    @Override
