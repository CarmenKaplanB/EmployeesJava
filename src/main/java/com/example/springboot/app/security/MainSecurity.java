...
@Configuration
@EnableWebSecurity
//con PostEnabled se usa para indicar a que métodos puede acceder solo el admin
// Los métodos que no lleven esta anotación pueden acceder como un usuario genérico
